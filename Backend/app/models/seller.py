...
class Seller:
    ...
    def to_dict(self, include_password=False):
        ...
        if include_password:
            seller_dict['password_hash'] = self.password_hash
        return seller_dict
    ...
    def from_dict(cls, data):
        """Create Seller instance from dictionary"""
        if '_id' in data:
    ...
    def from_bson(cls, bson_doc):
        """Create Seller instance from MongoDB document"""
        if bson_doc is None:
            return None
        return cls(
