      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 pt-4 pb-4 px-3 md:px-6">
        ...
        <div className="relative group flex-1 max-w-2xl transition-all">
          ...
          <input
            ...
            className="bg-slate-50 border border-slate-200 rounded-[2rem] py-4 pl-14 pr-8 text-sm font-semibold tracking-normal text-slate-900 focus:bg-white focus:border-blue-600 outline-none w-full shadow-lg shadow-slate-200/40 transition-all placeholder:text-slate-400"
          />
        </div>
      </div>
            ...
            filteredOrders.map((order) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  ...
                  <span className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider shadow-sm border ${getStatusStyle(order.status)}`}>
