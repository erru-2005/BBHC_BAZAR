  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pb-20 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                 ...
                 <span className="text-xl font-black text-blue-600 tracking-tight font-outfit uppercase">Creation</span>
              </div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-0.5">Marketplace Entry Protocol</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="relative z-10 mx-auto max-w-4xl pt-32 space-y-10">
        ...
        >
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase font-outfit">Initialize Asset</h1>
          <p className="text-sm font-bold text-slate-500 mt-2 uppercase tracking-[0.2em] opacity-80">
             Define parameters for your new marketplace listing.
          </p>
        </motion.div>
