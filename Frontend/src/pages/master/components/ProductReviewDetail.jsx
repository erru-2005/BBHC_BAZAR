...
import { FaStar, FaBox, FaConciergeBell, FaArrowLeft, FaStore } from 'react-icons/fa'

/**
 * ProductReviewDetail (Master)
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6">
        ...
        {/* Reviews Grid - 2 columns on large screens */}
            ...
            {group.reviews.map((review, i) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-slate-300 to-slate-400 flex items-center justify-center text-white font-bold uppercase text-sm shrink-0">
