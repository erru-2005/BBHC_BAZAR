        ...
        {showRejectModal && selectedOrder && (
          ...
          >
            <motion.div
              ...
              className="master-modal-panel bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4"
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Reject Order</h2>
              <p className="text-gray-600 mb-4">
                You are about to reject order <strong>#{selectedOrder.orderNumber}</strong>.
              </p>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4 text-sm text-red-800">
                <strong>Notice:</strong> This action will notify the user and seller about the rejection.
              </div>
